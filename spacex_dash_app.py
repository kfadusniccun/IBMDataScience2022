...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        pie_df=select_df['class'].value_counts()
...
def scatter(entered_site,payload):
    ...
    range_df = spacex_df[spacex_df['Payload Mass (kg)'].between(low,high)]
    if entered_site == 'ALL':
        ...
        fig = px.scatter(range_df[range_df['Launch Site']==entered_site],
        x='Payload Mass (kg)',
        y='class',
        color='Booster Version Category',
